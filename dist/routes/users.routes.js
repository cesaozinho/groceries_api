...
usersRouter.delete('/', ensureAuthenticated_1.ensureAuthenticated, function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var id, deleteUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = request.user.id;
                deleteUser = new DeleteUserService_1.default();
                return [4 /*yield*/, deleteUser.execute(id)];
            case 1:
                _a.sent();
